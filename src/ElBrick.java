/*
 * This class will house the ElBrick of the Tetris Game
 */
/**
 * Class for the ElBrick
...
{
    public ElBrick(Color color, int orient, int numSeg, int col){
    ...
    public int[][] initPosition(int cols)
    {
        ...
        int position[][] = {{referenceCol-1,1}, {referenceCol,1}, {referenceCol+1,1}, {referenceCol+1,0}};
        return position;
    }
